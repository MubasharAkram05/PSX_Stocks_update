...
//   GET    -> list stocks in order
//   POST   { symbol }              -> add a stock to the end
//   DELETE { symbol }              -> remove a stock
//   PATCH  { symbol, direction }   -> move a stock 'up' or 'down'
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      await pool.query(
        `INSERT INTO stock_list (symbol, sort_order) VALUES ($1, $2)
