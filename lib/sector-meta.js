...
module.exports = {
  ...
  CNERGY: 'petroleum', APL: 'petroleum', PRL: 'petroleum',
  ...
  PIOC: 'cement', CHCC: 'cement', KOHC: 'cement', ACPL: 'cement', BWCL: 'cement',

  SYS: 'tech', TRG: 'tech', NETSOL: 'tech', AVN: 'tech', PTC: 'tech', AIRLINK: 'tech',

  HUBC: 'power', KAPCO: 'power', KEL: 'power', NPL: 'power',

  ICI: 'chemical', LOTCHEM: 'chemical', EPCL: 'chemical',

  INDU: 'auto', PSMC: 'auto', HCAR: 'auto', MTL: 'auto', SAZEW: 'auto', GTYR: 'auto',

  ISL: 'engineering', ASTL: 'steel', MUGHAL: 'steel', ITTEEFAQ: 'steel',

  MEBL: 'bank', UBL: 'bank', HBL: 'bank', MCB: 'bank', BAHL: 'bank',
  ABL: 'bank', BOP: 'bank', NBP: 'bank', FABL: 'bank', AKBL: 'bank',

  NML: 'textile', KTML: 'textile', ILP: 'textile',
  DFSM: 'textile', MQTM: 'textile', TATM: 'textile', GATM: 'textile',

  THCCL: 'cement',

  DCR: 'other', PKGS: 'other', BNL: 'other', FFL: 'other',
  SPSL: 'other', TREET: 'other', FFLM: 'other', TOMCL: 'other', COLG: 'other',
};
